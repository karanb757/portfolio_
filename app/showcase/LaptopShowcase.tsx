    ...
    <div className="h-screen">
      ...
      <div className="grid grid-cols-5 grid-rows-5 gap-4 mt-12  pl-2 pr-2">
        ...
        <div className="col-start-1 row-start-5 bg-[#161616] text-[#D9D9D9] card flex h-[157px] w-full border-1 border-[#262626] cursor-pointer flex-col justify-between py-6 focus:z-[99px] p-3 gap-6 rounded-3xl">
          ...
          <p className="text-xs text-white">Within the realm of designers, I&apos;m recognised by the alias</p>
        </div>
        ...
        <div className="col-span-2 row-span-2 col-start-2 row-start-3 border-8 text-white border-[#604BB5] bg-[#4D389A] rounded-3xl p-9 pl-10 flex flex-col gap-8">
        ...
        <div className="col-span-3 col-start-2 row-start-5 p-3 text-[#D9D9D9] bg-[#161616] border-1 border-[#262626] flex flex-col items-center gap-2 rounded-3xl justify-center">  
            ...
            <div className="flex h-13 w-180 justify-center gap-3">
            <Image src='/vscode.webp' alt="VSCode" width={52} height={52} className="transition-transform duration-300 hover:scale-125"/>
            <Image src="/notion.png" alt="Notion" width={52} height={52} className="transition-transform duration-300 hover:scale-125"/>
            <Image src="/STACK/github.png" alt="Github" width={52} height={22} className="transition-transform duration-300 hover:scale-125"/>
            ...
            <Image src="/STACK/image.png" alt="Database" width={52} height={52} className="transition-transform duration-300 hover:scale-125"/>
        ...
        <div className="row-span-4 col-start-5 row-start-1 border-1 border-[#262626] bg-[#161616] rounded-3xl">
          ...
          <div className=" h-[520px] p-3 mt-2 rounded-3xl  border-[#262626] flex flex-col">
            ...
            <div className="flex flex-col gap-3 pt-10">
              ...
              <div className="flex flex-col">
                <div className="flex justify-between">
                    <span className="text-lg font-bold text-white">AI-LMS</span>
              ...
              <div className="flex flex-col">
                <div className="flex justify-between">
                    <span className="text-lg font-bold text-white">Skiper-UI</span>
