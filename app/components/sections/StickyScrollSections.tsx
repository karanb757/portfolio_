...
//             width={300}
//             height={300}
//             className="w-24 sm:w-32 md:w-36 lg:w-27 h-24 sm:h-32 md:h-36 lg:h-35 object-contain scale-110 sm:scale-125 transition-transform duration-300 hover:scale-125 sm:hover:scale-150  mt-15"
//             alt="c++ logo"
//           />
//         </div>
//       ),
...
//             width={300}
//             height={300}
//             className="w-24 sm:w-32 md:w-36 lg:w-50 h-24 sm:h-32 md:h-36 lg:h-60 object-cover scale-110 sm:scale-125 transition-transform duration-300 hover:scale-125 sm:hover:scale-150  mt-15"
//             alt="c++ logo"
//           />
//         </div>
//       ),
...
//             width={300}
//             height={300}
//             className="w-28 sm:w-32 md:w-36 lg:w-35 h-28 sm:h-32 md:h-36 lg:h-35 object-contain object-center transition-transform duration-300 hover:scale-110 sm:hover:scale-125"
//             alt="JavaScript Logo"
//           />
//         </div>
//       ),
...
//             width={300}
//             height={300}
//             className="w-24 sm:w-32 md:w-36 lg:w-40 h-24 sm:h-32 md:h-36 lg:h-40 object-cover scale-110 sm:scale-125 transition-transform duration-300 hover:scale-125 sm:hover:scale-150  mt-15"
//             alt="HTML Logo"
//           />
//         </div>
//       ),
...
//             width={300}
//             height={300}
//             className="w-40 sm:w-48 md:w-56 lg:w-60 h-40 sm:h-48 md:h-56 lg:h-60 object-contain pb-2 sm:pb-4 transition-transform duration-300 hover:scale-110 sm:hover:scale-125"
//             alt="CSS Logo"
//           />
//         </div>
//       ),
...
//             width={300}
//             height={300}
//             className="h-43 w-130 sm:h-36 md:h-40 lg:h-36 transition-transform duration-300 hover:scale-110 sm:hover:scale-125"
//             alt="React Logo"
//           />
//         </div>
//       ),
...
//             width={300}
//             height={300}
//             className="w-40 sm:w-48 md:w-56 lg:w-60 h-28 sm:h-32 md:h-34 lg:h-35 object-center transition-transform duration-300 hover:scale-110 sm:hover:scale-125"
//             alt="Next.js Logo"
//           />
//         </div>
//       ),
...
//             width={300}
//             height={300}
//             className="w-24 sm:w-32 md:w-36 lg:w-60 h-20 sm:h-32 md:h-36 lg:h-35 object-contain scale-110 sm:scale-125 transition-transform duration-300 hover:scale-125 sm:hover:scale-150 mt-15"
//             alt="Zustand logo"
//           />
//         </div>
//       ),
...
//             width={300}
//             height={300}
//             className="w-24 sm:w-32 md:w-36 lg:w-40 h-24 sm:h-32 md:h-36 lg:h-40 pb-6 object-cover scale-110 sm:scale-125 transition-transform duration-300 hover:scale-125 sm:hover:scale-150 mt-15"
...
//               width={300}
//               height={300}
//               className="w-40 sm:w-48 md:w-56 lg:w-60 h-40 sm:h-48 md:h-56 lg:h-50 pt-2 sm:pt-4 object-contain object-center pb-6 sm:pb-8 md:pb-10 transition-transform duration-300 hover:scale-110 sm:hover:scale-125"
//               alt="MongoDB"
//             />
//           </div>
//         ),
...
//               width={300}
//               height={300}
//               className="w-24 sm:w-32 md:w-36 lg:w-40 h-28 sm:h-32 md:h-36 lg:h-50 object-cover scale-110 sm:scale-125 transition-transform duration-300 hover:scale-125 sm:hover:scale-150 mt-15"
//               alt="Supabase logo"
//             />
//           </div>
//         ),
...
//             width={300}
//             height={300}
//             className="w-24 sm:w-32 md:w-36 lg:w-40 h-24 sm:h-32 md:h-36 lg:h-40 object-contain sm:scale-125 transition-transform duration-300 hover:scale-125 sm:hover:scale-150 mt-15"
//             alt="Express.js logo"
//           />
//         </div>
//       ),
...
//             width={300}
//             height={300}
//             className="w-40 sm:w-48 md:w-56 lg:w-60 h-32 sm:h-40 md:h-45 lg:h-40 object-contain object-center pb-6 sm:pb-8 md:pb-10 transition-transform duration-300 hover:scale-110 sm:hover:scale-125"
//             alt="Node.js Logo"
//           />
//         </div>
//       ),
...
//         <div className="flex w-60 items-center justify-center bg-black ">
//           <img
//             src="/StickyScroll/restfulAPI2.png"
//             width={300}
//             height={300}
//             className="w-24 sm:w-32 md:w-36 lg:w-40 h-24 sm:h-32 md:h-36 lg:h-40 object-contain scale-110 sm:scale-125 transition-transform duration-300 hover:scale-125 sm:hover:scale-150 mt-15"
        ...
        content: (
          <div className="flex w-60 h-60 items-center justify-center bg-black ">
            <img
              ...
              width={300}
              height={300}
              className="max-w-32 max-h-32 sm:max-w-36 sm:max-h-36 md:max-w-40 md:max-h-40 lg:max-w-36 lg:max-h-36 object-contain scale-110 sm:scale-125 transition-transform duration-300 hover:scale-125 sm:hover:scale-150"
              alt="c logo"
            />
          </div>
        ),
